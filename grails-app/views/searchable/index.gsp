...
<html>
    <head>
        <title>Search Campaign / Idea / Comments - Pollster</title>
        <link rel="stylesheet" href="/pollster/css/main.css" />
  ...
  <body>
  <div id="header">
    <h1>Powered by <a href="http://www.grails.org/plugin/searchable" target="_blank"><span>Searchable</span></a></h1>

    <g:form url='[controller: "searchable", action: "index"]' id="searchableForm" name="searchableForm" method="get">
        <g:textField name="q" value="${params.q}" size="60" style="height:22px;margin:4px 0" /> 
	<input type="submit" value="Search" style="height:22px;margin:4px 0" />
    </g:form>
