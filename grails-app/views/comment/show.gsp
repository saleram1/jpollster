            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.theIdea.label" default="The Idea" /></td>
                            
                            <td valign="top" class="value"><g:link controller="idea" action="show" id="${commentInstance?.theIdea?.id}">${commentInstance?.theIdea?.encodeAsHTML()}</g:link></td>
